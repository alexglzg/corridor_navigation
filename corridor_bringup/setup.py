...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'maps/large_rooms'), glob('maps/large_rooms/*')),
        ...
        (os.path.join('share', package_name, 'params/lattices'), glob('params/lattices/*.json')),
    ],
